                              ...
                              <form action="{{ route('withdraw') }}" method="POST"> 
                                ...
                                <div class="form-group no-mb">
                                    ...
                                    <div class="input-group mb-10">
                                        ...
                                        <input type="text" class="form-control" placeholder="OxsD12F32xvW3deG5..." name="wallet" required>
                                    </div>
                                   
                                    <button type="submit" class="btn btn-primary btn-lg mt-20 has-gradient-to-right-bottom" style="width:100%">Withdraw</button>
                                </div>
                              </form>
                            </div>
                        </div>
