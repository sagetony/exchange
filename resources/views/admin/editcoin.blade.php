...
<div class="main-content app-content">
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <div class="d-flex">
                ...
                <p class="text-muted mb-0 hover-cursor">&nbsp;/&nbsp;Coin Details&nbsp;</p>
    ...
    <marquee behavior="" direction=""><h3>NOTE: Do not fill any information on the COIN ID field</h3></marquee>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-lg-12 col-xl-12 mx-auto d-block">
                                            <div class="card card-body pd-10 pd-md-20 border shadow-none">
                                                <h5 class="card-title mg-b-20">Coin Details</h5>
                                                <form action="{{ route('editcoin') }}" method="post">
                                                @csrf
                                                <div class="form-group">
                                                    <label class="main-content-label tx-11 tx-medium tx-gray-600">Coin Id</label> <input class="form-control" value= "{{ $data->coinId}}" name="id" type="text" id="id">
                                                </div>
                                                 <div class="form-group">
                                                    <label class="main-content-label tx-11 tx-medium tx-gray-600">Coin Name</label> <input class="form-control" value= "{{ $data->coinName}}" name="name" type="text" id="name">
                                                </div>
                                                 <div class="form-group">
                                                    <label class="main-content-label tx-11 tx-medium tx-gray-600">Coin Address</label> <input class="form-control" value= "{{ $data->coinAddress}}" name="address" type="text" id="address">
                                                </div>                                              
                                                <button class="btn btn-main-primary btn-block" name="sub" type="submit">Edit Coin Details</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
