                                        ...
                                        <div class="col-md-12 col-lg-12 col-xl-12 mx-auto d-block">
                                            <div class="card card-body pd-10 pd-md-20 border shadow-none">
                                                ...
                                                <div class="form-group">
                                                    <label class="main-content-label tx-11 tx-medium tx-gray-600">Sponsor Name</label> <input required class="form-control"name="sponsorname" type="text" id="id" value="">
                                                </div>
                                                <div class="form-group">
                                                    <label class="main-content-label tx-11 tx-medium tx-gray-600">Sponsor ID</label> <input required class="form-control"name="sponsorId" type="text" id="id" value="">
                                                </div>
                                                <div class="form-group">
                                                    <label class="main-content-label tx-11 tx-medium tx-gray-600">Name Sponsored</label> <input required class="form-control"name="namesponsor" type="text" id="id" value="">
                                                </div>
                                                <div class="form-group">
                                                    <label class="main-content-label tx-11 tx-medium tx-gray-600">Amount ($)</label> <input required class="form-control"name="amount" type="text" id="id" value="">
                                                </div>
                                                
                                                <button class="btn btn-main-primary btn-block" name="sub" type="submit">Create Bonus</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
