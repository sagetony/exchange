                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-lg-12 col-xl-12 mx-auto d-block">
                                            <div class="card card-body pd-10 pd-md-20 border shadow-none">
                                                <h5 class="card-title mg-b-20">Create Deposit</h5>
                                                ...
                                                <div class="form-group">
                                                    <label class="main-content-label tx-11 tx-medium tx-gray-600">Investment Plan</label>
                                                    <select class="form-control mb-3" name="package" id="package">
            
                                                       <option selected="">Select Investment Plan</option>
                                                       @foreach ($plans as $dac)
                                                        <option value="{{ $dac->packageName }}">{{ $dac->packageName}}</option>
                                                       @endforeach
                                                    </select>
                                                 </div>
                                                 <div class="form-group">
                                                    <label class="main-content-label tx-11 tx-medium tx-gray-600">Coin</label> <input required class="form-control"name="coin" type="text" id="coin">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <button class="btn btn-main-primary btn-block" name="sub" type="submit">Invest Now</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
