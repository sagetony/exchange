    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            ...
            <div class="d-flex">
                ...
                <p class="text-muted mb-0 hover-cursor">&nbsp;/&nbsp;Bonus&nbsp;</p>
                                ...
                                <table class="table table-bordered table-hover table-striped text-nowrap mb-0 tx-13" >
                                    ...
                                    <tbody>
                                        <tr class="border-bottom">
                                            ...
                                            <td>{{ $datadeposit->sponsorId }}</td>
                                            <td>{{ $datadeposit->amount }}</td>
                                            <td>{{ $datadeposit->nameSponsered }}</td>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    @endif
                                                    <a class="btn btn-info" data-toggle="" title="Edit Bonus" href="{{ Route('editbonus', ['id' => $datadeposit->bonusId]) }}"><i class="fa fa-edit"></i></a> 
                                                    <button class="btn btn-danger" data-toggle="modal" title="Delete Transaction" data-target='#myModalDELETED{{ $datadeposit->bonusId }}'><i class="fa fa-trash"></i></button>
                                                ...
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a type="submit" class="btn btn-danger" href="{{Route('adminbonus', ['unconfirmid' => $datadeposit->bonusId])}} ">Pending Transaction</a>
                                            ...
                                            <div id="myModalDELETED{{$datadeposit->bonusId}}" class="modal fade" role="dialog">
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a type="button" class="btn btn-danger" href="{{ Route('adminbonus', ['deleteid' => $datadeposit->bonusId]) }}">Delete Transaction</a>
                                                            <button type="button" class="btn btn-default"  data-dismiss="modal">Close</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div id="myModalUNLOCK{{ $datadeposit->bonusId }}" class="modal fade" role="dialog">
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-footer">
                                                        <a type="button" class="btn btn-danger" href="{{ Route('adminbonus', ['confirmid' =>  $datadeposit->bonusId]) }}">Confirm Transaction</a>
                                                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                                    </div>
                                                </div>
