...
<div class="main-content app-content">
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <div class="d-flex">
                ...
                <p class="text-muted mb-0 hover-cursor">&nbsp;/&nbsp;Withdrawal Details&nbsp;</p>
    ...
    <marquee behavior="" direction=""><h3>NOTE: Do not fill any information on the Withdrawal ID field</h3></marquee>
    ...
    <div class="col-xl-6 col-lg-6 col-md-12">
            <div class="card crypto crypt-primary overflow-hidden">
                <div class="card-body iconfont text-left">
                    <div class="media">
                        <div class="Withdrawal-logo bg-primary-transparent">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-lg-12 col-xl-12 mx-auto d-block">
                                            <div class="card card-body pd-10 pd-md-20 border shadow-none">
                                                <h5 class="card-title mg-b-20">Withdrawal Details</h5>
                                                <form action="{{ route('editwithdraw') }}" method="post">
                                                @csrf
                                                <div class="form-group">
                                                    <label class="main-content-label tx-11 tx-medium tx-gray-600">Withdrawal Id</label> <input class="form-control" value= "{{ $data->transactionId}}" name="id" type="text" id="id">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <button class="btn btn-main-primary btn-block" name="sub" type="submit">Edit Withdrawal Details</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
