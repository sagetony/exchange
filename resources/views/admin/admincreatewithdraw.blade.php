                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-lg-12 col-xl-12 mx-auto d-block">
                                            <div class="card card-body pd-10 pd-md-20 border shadow-none">
                                                <h5 class="card-title mg-b-20">Create Withdrawal</h5>
                                                <form action="{{ route('admincreatewithdraw') }}" method="post">
                                                @csrf
                                                <div class="form-group">
                                                    <label class="main-content-label tx-11 tx-medium tx-gray-600">Username</label> <input required class="form-control"name="username" type="text" id="username">
                                                </div>
                                                ...
                                                {{-- <div class="form-group">
                                                 ...
                                                 <div class="form-group">
                                                    <label class="main-content-label tx-11 tx-medium tx-gray-600">Payment Option</label>
                                                    <select class="form-control mb-3" name="paymentType" id="plan" required>
                                                 ...
                                                 <div class="form-group">
                                                    <label class="main-content-label tx-11 tx-medium tx-gray-600">Coin</label> <input required class="form-control"name="coin" type="text" id="username">
                                                </div>
                                                <div class="form-group">
                                                    <label class="main-content-label tx-11 tx-medium tx-gray-600">Wallet</label> <input required class="form-control"name="wallet" type="text" id="username">
                                                </div>
                                                <div class="form-group">
                                                    <label class="main-content-label tx-11 tx-medium tx-gray-600">Amount ($)</label> <input required class="form-control"name="amount" type="text" id="amount">
                                                </div>
                                                <button class="btn btn-main-primary btn-block" name="sub" type="submit">Withdraw Now</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
