    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <div class="d-flex">
                ...
                <p class="text-muted mb-0 hover-cursor">&nbsp;/&nbsp;Edit Package&nbsp;</p>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-lg-12 col-xl-12 mx-auto d-block">
                                            <div class="card card-body pd-10 pd-md-20 border shadow-none">
                                                <h5 class="card-title mg-b-20">Edit Package</h5>
                                                <form action="{{ route('editpackage') }}" method="post">
                                                @csrf
                                               
                                                <div class="form-group">
                                                    <label class="main-content-label tx-11 tx-medium tx-gray-600">Investment Plan</label>
                                                    <select class="form-control mb-3" name="name" id="plan" required>
                                                ...
                                                <div class="form-group">
                                                    <label class="main-content-label tx-11 tx-medium tx-gray-600">Rate</label> <input required class="form-control" name="rate" type="text" id="amount">
                                                </div>
                                                <button class="btn btn-main-primary btn-block" name="sub" type="submit">Update Rate Now</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
