            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
              ...
              <tr>
                <td bgcolor="#ffffff" align="left" style="padding: 20px 30px 20px 30px; color: #666666; font-family: 'Poppins', sans-serif; font-size: 16px; font-weight: 400; line-height: 25px; text-align:justify;">
                  <p style="margin: 0;">You have successfully deposited ${{ $details['amount'] }} to your  account. Your transaction ID to keep track of your payment is {{ $details['id'] }}..</p>
                </td>
              </tr>
              ...
              <tr>
                <td bgcolor="#ffffff" align="left" style="padding: 0px 30px 20px 30px; color: #666666; font-family: &apos;Lato&apos;, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 25px; text-align:justify;">
                  <p style="margin: 0;">Trusted by thousands worldwide,  Company platform is dedicated to increasing the freedom of money for users, and features an unmatched portfolio of financial products and offerings, which includes: Assets Management, Forex investment, Forex Signals, Forex Training, data and research.</p>
                </td>
              </tr>
              <!-- COPY -->
              <tr>
